...
```{python}
cm, df, f1 = pixel_conf_mat(ds_path, target_dir, train_data_dir, predfile, class_map, result_dir=plot_dir, crop='zea mays')
```
...
```{python}
cm, df, f1 = pixel_conf_mat(ds_path, target_dir, train_data_dir, predfile, None, result_dir=plot_dir, crop='maize')
```
...
```{python}
cm, df, f1 = pixel_conf_mat(ds_path, target_dir, train_data_dir, predfile, class_map, result_dir=plot_dir, crop='maize')
```
...
```{python}
cm, df, f1 = pixel_conf_mat(ds_path, target_dir, train_data_dir, predfile, json.dumps({c: c for c in train_classes}), result_dir=plot_dir, crop='maize')
```
