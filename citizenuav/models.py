...
class InatClassifier(pl.LightningModule, ABC):
    ...
    def training_epoch_end(self, outputs: EPOCH_OUTPUT) -> None:
        ...
        log_content = {"train_f1": train_f1, "train_prec": train_prec, "train_rec": train_rec, "train_acc": train_acc}
    ...
    def validation_epoch_end(self, outputs: EPOCH_OUTPUT) -> None:
        ...
        self.log_dict({"val_f1": val_f1, "val_prec": val_prec, "val_rec": val_rec, "val_acc": val_acc})
    ...
    def test_epoch_end(self, outputs: EPOCH_OUTPUT) -> None:
        ...
        self.log_dict({"test_f1": test_f1, "test_prec": test_prec, "test_rec": test_rec, "test_acc": test_acc})
...
class InatSequentialClassifier(InatClassifier):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument(
            "--weights", type=str, default=None, help="String key of the weights to be loaded from torchvision."
        )
        parser.add_argument(
            "--checkpoint_path", type=str, default=None, help="Path to a pre-trained backbone model checkpoint."
        )
        parser.add_argument("--hub_link", type=str, default=None, help="Relative path to torch hub weights.")
...
class InatMogaNetClassifier(InatClassifier):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--admw_beta1", type=float, default=0.9, required=False)
        parser.add_argument("--admw_beta2", type=float, default=0.999, required=False)
